...
print(f"the sum of loans is ${total_loan_cost}")
...
print(f"the average of loans is ${average_loan_cost}")
...
remaining_months = 9
future_value = loan.get("loan_price") * 1.20
...
present_value = future_value / 0.10 ** remaining_months
...
print("The inexpensive loans will be: ", inexpensive_loans)
